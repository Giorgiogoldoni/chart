...
# ── SOTTOSTANTI ─────────────────────────────────────────────
UNDERLYINGS = [
    # Single stock USA — Tier 1
    {'ticker':'GOOGL','name':'Alphabet (Google)','etps':['3LAL','3GOO'],'market':'US','tier':1},
    {'ticker':'NVDA', 'name':'NVIDIA',           'etps':['3NVD','3LNV'],'market':'US','tier':1},
    {'ticker':'AAPL', 'name':'Apple',            'etps':['3AAP','3LAP'],'market':'US','tier':1},
    {'ticker':'AMZN', 'name':'Amazon',           'etps':['3AMZ','3LZN'],'market':'US','tier':1},
    {'ticker':'MSFT', 'name':'Microsoft',        'etps':['3MSF','3LMS'],'market':'US','tier':1},
    # Single stock USA — Tier 2
    {'ticker':'TSLA', 'name':'Tesla',            'etps':['3TSL','3LTS'],'market':'US','tier':3},
    {'ticker':'META', 'name':'Meta (Facebook)',  'etps':['3FB','3LFB'],'market':'US','tier':2},
    {'ticker':'NFLX', 'name':'Netflix',          'etps':['3NFL','3LNF'],'market':'US','tier':2},
    {'ticker':'AMD',  'name':'AMD',              'etps':['3AMD','3LAM'],'market':'US','tier':2},
    {'ticker':'UBER', 'name':'Uber',             'etps':['3UBR','3LUB'],'market':'US','tier':2},
    {'ticker':'ARM',  'name':'ARM Holdings',     'etps':['ARM3'],'market':'US','tier':2},
    {'ticker':'UNH',  'name':'UnitedHealth',     'etps':['UNH3'],'market':'US','tier':2},
    # Single stock USA — Tier 3
    {'ticker':'PYPL', 'name':'PayPal',           'etps':['3PYP','3LPP'],'market':'US','tier':3},
    {'ticker':'COIN', 'name':'Coinbase',         'etps':['3CON','3LCO'],'market':'US','tier':3},
    {'ticker':'MSTR', 'name':'MicroStrategy',    'etps':['3MST','3LMI'],'market':'US','tier':3},
    {'ticker':'SPOT', 'name':'Spotify',          'etps':['3LPO'],'market':'US','tier':3},
    {'ticker':'NIO',  'name':'NIO',              'etps':['3NIO','3LNI'],'market':'US','tier':3},
    {'ticker':'SQ',   'name':'Block (Square)',   'etps':['3SQ','3LSQ'],'market':'US','tier':3},
    {'ticker':'PLTR', 'name':'Palantir',         'etps':['3LPA'],'market':'US','tier':3},
    {'ticker':'BABA', 'name':'Alibaba',          'etps':['3BAB','3LAA'],'market':'US','tier':3},
    {'ticker':'SMCI', 'name':'Super Micro Computer','etps':['SMCI'],'market':'US','tier':3},
    # Indici USA — Tier 1
    {'ticker':'SPY',  'name':'S&P 500',          'etps':['3USL','5SPY','WSPX'],'market':'US','tier':1},
    {'ticker':'QQQ',  'name':'Nasdaq 100',       'etps':['QQQ3','5QQQ','WNAS'],'market':'US','tier':1},
    {'ticker':'IWM',  'name':'Russell 2000',     'etps':['WRTY'],'market':'US','tier':2},
    {'ticker':'SOXX', 'name':'Semiconductors',   'etps':['3SEM','SOXL'],'market':'US','tier':2},
    # Indici Europa — Tier 1
    {'ticker':'^GDAXI',   'name':'DAX',          'etps':['3DEL'],'market':'EU','tier':1},
    {'ticker':'FTSEMIB.MI','name':'FTSE MIB',    'etps':['3ITL','5MIB'],'market':'EU','tier':1},
    {'ticker':'^FCHI',    'name':'CAC 40',       'etps':['3CAC'],'market':'EU','tier':1},
    {'ticker':'^FTSE',    'name':'FTSE 100',     'etps':['3UKL','2UKL'],'market':'EU','tier':1},
    {'ticker':'^STOXX50E','name':'Euro Stoxx 50','etps':['3EUL','5EUL','WS5X'],'market':'EU','tier':1},
    {'ticker':'^STOXX',   'name':'STOXX Europe Banks','etps':['3BAL'],'market':'EU','tier':2},
    # Titoli europei — Tier 2
    {'ticker':'UCG.MI', 'name':'Unicredit',      'etps':['3LCR'],'market':'EU','tier':2},
    {'ticker':'ISP.MI', 'name':'Intesa Sanpaolo','etps':['3LSP'],'market':'EU','tier':2},
    {'ticker':'RACE.MI','name':'Ferrari',        'etps':['3RAC'],'market':'EU','tier':2},
    # Materie prime — Tier 1
    {'ticker':'GC=F', 'name':'Gold',             'etps':['3GOL'],'market':'CMD','tier':1},
    {'ticker':'CL=F', 'name':'WTI Crude Oil',    'etps':['3OIL','LOIL','WTI','3OIS','PCRD'],'market':'CMD','tier':2},
    {'ticker':'BZ=F', 'name':'Brent Crude Oil',  'etps':['3BRL','BRENT','PBRT'],'market':'CMD','tier':2},
    {'ticker':'SI=F', 'name':'Silver',           'etps':['3SIL','SLVR'],'market':'CMD','tier':2},
    {'ticker':'HG=F', 'name':'Copper',           'etps':['3HCL','LCOP','CPER','ECOP'],'market':'CMD','tier':2},
    # Materie prime — Tier 3
    {'ticker':'NG=F', 'name':'Natural Gas',      'etps':['3NGL','GAS'],'market':'CMD','tier':3},
    {'ticker':'ZW=F', 'name':'Wheat',            'etps':['3WHL','LWEA'],'market':'CMD','tier':3},
    {'ticker':'ZC=F', 'name':'Corn',             'etps':['CORN','LCOR'],'market':'CMD','tier':3},
    {'ticker':'ZS=F', 'name':'Soybeans',         'etps':['ESOY'],'market':'CMD','tier':3},
    {'ticker':'SB=F', 'name':'Sugar',            'etps':['SUGA','3SUL','LSUG'],'market':'CMD','tier':3},
    {'ticker':'KC=F', 'name':'Coffee',           'etps':['3CFL','LCFE','ECOF'],'market':'CMD','tier':3},
    {'ticker':'CC=F', 'name':'Cocoa',            'etps':['COCO','LCOC'],'market':'CMD','tier':3},
    {'ticker':'PA=F', 'name':'Palladium',        'etps':['2PAL'],'market':'CMD','tier':3},
    {'ticker':'PL=F', 'name':'Platinum',         'etps':['LPLA','PHPT'],'market':'CMD','tier':3},
    {'ticker':'AL=F', 'name':'Aluminium',        'etps':['LALU','ALUM','EALU'],'market':'CMD','tier':3},
    {'ticker':'UX=F', 'name':'Uranium',          'etps':['NCLR'],'market':'CMD','tier':3},
]
